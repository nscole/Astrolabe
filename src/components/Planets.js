    ...
    return <div  className="container-fluid planetstogether">
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={mercuryPopUp} setTrigger={setMercuryPopUp}>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Mercury_in_true_color.jpg/440px-Mercury_in_true_color.jpg" alt="Planet Mercury"/>;
                    <h1>Mercury</h1>;
                    <p>Description: Mercury is the smallest planet in the Solar System and the closest to the Sun. Its orbit around the Sun takes 87.97 Earth days, the shortest of all the Sun's planets.",</p>
                </Popup>
            </div>
            <div className="planetdivs">
                <main>
                ...
                <Popup trigger={VenusPopUp} setTrigger={setVenusPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Venus_from_Mariner_10.jpg/440px-Venus_from_Mariner_10.jpg" alt="Planet Venus"/>
                     <h1>Venus</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={EarthPopUp} setTrigger={setEarthPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/The_Blue_Marble_%28remastered%29.jpg/440px-The_Blue_Marble_%28remastered%29.jpg" alt="Planet Eath"/>
                     <h1>Earth</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={MarsPopUp} setTrigger={setMarsPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/OSIRIS_Mars_true_color.jpg/440px-OSIRIS_Mars_true_color.jpg" alt="Planet Mars"/>
                     <h1>Mars</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={JupiterPopUp} setTrigger={setJupiterPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Jupiter_and_its_shrunken_Great_Red_Spot.jpg/440px-Jupiter_and_its_shrunken_Great_Red_Spot.jpg" alt="Planet Jupiter"/>
                     <h1>Jupiter</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={SaturnPopUp} setTrigger={setSaturnPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Saturn_during_Equinox.jpg/600px-Saturn_during_Equinox.jpg" alt="Planet Saturn"/>
                     <h1>Saturn</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={UranusPopUp} setTrigger={setUranusPopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Uranus_as_seen_by_NASA%27s_Voyager_2_%28remastered%29_-_JPEG_converted.jpg/440px-Uranus_as_seen_by_NASA%27s_Voyager_2_%28remastered%29_-_JPEG_converted.jpg" alt="Planet Uranus"/>
                     <h1>Uranus</h1>
            ...
            <div className="planetdivs">
                ...
                <Popup trigger={NeptunePopUp} setTrigger={setNeptunePopUp}>
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Neptune_-_Voyager_2_%2829347980845%29_flatten_crop.jpg/440px-Neptune_-_Voyager_2_%2829347980845%29_flatten_crop.jpg"/>
                     <h1>Neptune</h1>
